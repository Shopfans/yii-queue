...
class Connection extends Component
{
    ...
    public function open()
    {
        ...
        if ($socket) {
            ...
            \Yii::log("Failed to open redis DB connection ($connection): $errorNumber - $errorDescription", \CLogger::LEVEL_ERROR, __CLASS__);
    ...
    public static function camel2words($name, $ucwords = true)
    {
        ...
        return $ucwords ? StringHelper::mb_ucwords($label, 'UTF-8') : $label;
    }
        ...
        if ($this->retries > 0) {
            ...
            while ($tries-- > 0) {
                try {
                    ...
                    \Yii::log($e, \CLogger::LEVEL_ERROR__METHOD__);
                    ...
                    try {
                        ...
                        \Yii::log($exception, \CLogger::LEVEL_ERROR, __METHOD__);
                        $this->close();
    ...
    private function redirect($redirect, $command, $params)
    {
        ...
        if ($this->redirectConnectionString) {
            \Yii::log('Redirecting to ' . $this->connectionString, \CLogger::LEVEL_INFO, __METHOD__);
